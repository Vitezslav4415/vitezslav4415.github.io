...
$(function() {
	var red = [], blue = [], yellow = [], green = [], trenloe = [], extrasurge = [], nodie = [], brown = [], gray = [], black = [];
	...
	trenloe.push(attackDieSide(1,0,0,1));
	extrasurge.push(attackDieSide(0,1,0,1));
	nodie.push(defenceDieSide(0,1));
	...
	var weapons = [], weapons2 = [], defenceDice = [], monsters = [];
	...
	weapons2.push(weapon('Astarra without shackle', [blue, yellow], [surgeEffect(0,2,0,1,false), surgeEffect(2,0,0,1,false)], 1, 1, true));
	weapons2.push(weapon('Astarra with shackle', [blue, yellow], [surgeEffect(0,2,0,1,false), surgeEffect(0,2,0,1,false), surgeEffect(2,0,0,1,false)], 1, 1, true));
	weapons2.push(weapon('Raythen ranged without shackle', [blue, yellow], [], 1, 1, true));
	weapons2.push(weapon('Raythen ranged with shackle', [blue, yellow], [surgeEffect(0,2,0,1,false)], 1, 1, true));
	weapons2.push(weapon('Mok without shackle', [blue, yellow], [surgeEffect(1,0,0,1,false)], 1, 1, true));
	weapons2.push(weapon('Mok with shackle', [blue, yellow], [surgeEffect(0,2,0,1,false), surgeEffect(1,0,0,1,false)], 1, 1, true));
	weapons2.push(weapon('Trenloe Jagged handaxe buffed without shackle', [blue, red, trenloe], [surgeEffect(1,0,0,1,false)], 1, 1, true));
	weapons2.push(weapon('Trenloe Jagged handaxe unbuffed without shackle', [blue, yellow, trenloe], [surgeEffect(1,0,0,1,false)], 1, 1, true));
	weapons2.push(weapon('Trenloe Rusted handaxe without shackle', [blue, green, trenloe], [surgeEffect(0,2,0,1,false)], 1, 1, true));
	weapons2.push(weapon('Trenloe Rusted handaxe dual strike without shackle', [blue, green, trenloe, extrasurge], [surgeEffect(0,2,0,1,false), surgeEffect(1,0,0,1,false)], 1, 1, true));
	weapons2.push(weapon('Trenloe Jagged handaxe buffed dual strike without shackle', [blue, red, trenloe, extrasurge], [surgeEffect(0,2,0,1,false), surgeEffect(1,0,0,1,false)], 1, 1, true));
	weapons2.push(weapon('Trenloe Jagged handaxe unbuffed dual strike without shackle', [blue, yellow, trenloe, extrasurge], [surgeEffect(0,2,0,1,false), surgeEffect(1,0,0,1,false)], 1, 1, true));
	weapons2.push(weapon('Trenloe Jagged handaxe buffed with shackle', [blue, red, trenloe], [surgeEffect(0,2,0,1,false), surgeEffect(1,0,0,1,false)], 1, 1, true));
	weapons2.push(weapon('Trenloe Jagged handaxe unbuffed with shackle', [blue, yellow, trenloe], [surgeEffect(0,2,0,1,false), surgeEffect(1,0,0,1,false)], 1, 1, true));
	weapons2.push(weapon('Trenloe Rusted handaxe with shackle', [blue, green, trenloe], [surgeEffect(0,2,0,1,false), surgeEffect(0,2,0,1,false)], 1, 1, true));
	weapons2.push(weapon('Trenloe Rusted handaxe dual strike with shackle', [blue, green, trenloe, extrasurge], [surgeEffect(0,2,0,1,false), surgeEffect(0,2,0,1,false), surgeEffect(1,0,0,1,false)], 1, 1, true));
	weapons2.push(weapon('Trenloe Jagged handaxe buffed dual strike with shackle', [blue, red, trenloe, extrasurge], [surgeEffect(0,2,0,1,false), surgeEffect(0,2,0,1,false), surgeEffect(1,0,0,1,false)], 1, 1, true));
	weapons2.push(weapon('Trenloe Jagged handaxe unbuffed dual strike with shackle', [blue, yellow, trenloe, extrasurge], [surgeEffect(0,2,0,1,false), surgeEffect(0,2,0,1,false), surgeEffect(1,0,0,1,false)], 1, 1, true));
	
	
	defenceDice.push({'title':'No die', 'die':nodie});
	...
	table += '<br/><table><tr><th>Attacker</th>';
	for (var i = 0; i < defenceDice.length; i++) {
		table += '<th>' + defenceDice[i].title + '</th>';
	}
	table += '</tr>';
	for (var i = 0; i < weapons2.length; i++) {
		var string = '<tr><td>' + weapons2[i].title + '</td>';
		var outcome = 0;
		for (var j = 0; j < defenceDice.length; j++) {
			string += '<td>' + (j == 3 ? '<b>' : '') + battleOutcome(sumNAttackDice(weapons2[i].dice),defenceDice[j].die,weapons2[i].surge,0) + (j == 3 ? '</b>' : '') + '</td>';
			if (j == 3) outcome = battleOutcome(sumNAttackDice(weapons2[i].dice),defenceDice[j].die,weapons2[i].surge,0);
		}
		string += '</tr>';
